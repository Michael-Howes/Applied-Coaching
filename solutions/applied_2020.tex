\section{Applied 2020: Solution\footnote{Isaac Gibbs and D.K.}}
...
\]
The log of this likelihood is again concave in $\lambda = \frac{1}{\sigma}$ and $\nu = \frac{\mu}{\sigma}$, and so we can find the global optimum easily.
